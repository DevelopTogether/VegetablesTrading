package com.checktoupdatedemo.adapter;
...
public class CheckUpdateDialogAdapter extends BaseAdapter {
    private Context context;
    private String[] infos;
    private ViewHoder hoder;

    public CheckUpdateDialogAdapter(Context context, String description) {
